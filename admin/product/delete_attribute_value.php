        ...
        <div class="col-md-6">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="attribute_value" class="form-control" id="attribute_value" value="<?php echo $res['attribute_value']; ?>" placeholder="Attribute value" readonly />
                </div>
                ...
                <?php if ($res['attribute_name'] == "Color") { ?>
                    ...
                    <div class="form-group" id="color">
                        ...
                        <input type="color" name="color" class="form-control" id="color" placeholder="Color" value="<?php echo $res['color'] ?>" readonly />
                    </div>
